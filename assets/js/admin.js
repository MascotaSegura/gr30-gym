...
function renderPlanes() {
 ...
 return `
 <div tabindex="0" class="${bgCls} p-8 sm:p-12 flex flex-col justify-between group hover:bg-brand-black hover:text-brand-white focus:bg-brand-black focus:text-brand-white active:bg-brand-black active:text-brand-white cursor-pointer">
 <div>
...
function staffFormHTML(s) {
 ...
 <div class="w-16 h-16 bg-brand-green text-brand-black flex items-center justify-center font-display font-bold text-2xl uppercase focus:outline-none focus:bg-brand-black focus:text-brand-white " tabindex="0" id="staff-photo-preview">
...
function memberFormHTML(m) {
 ...
 <button type="button" onclick="resetMemberPIN(${m.id})" class="border-4 border-brand-black w-full sm:w-auto text-center font-display font-bold uppercase tracking-widest text-xs px-6 py-4 bg-brand-black text-brand-white hover:bg-brand-green hover:text-brand-black focus:outline-none">Restablecer PIN</button>
 </div>
 ` : `
...
function planFormHTML(p) {
 ...
 <div>
 <label class="flex items-center gap-4 cursor-pointer font-display font-bold uppercase tracking-widest text-xs sm:text-sm text-brand-black group focus-within:text-brand-green ">
 <div class="relative w-8 h-8 border-4 border-brand-black bg-brand-white group-hover:bg-brand-green group-focus-within:bg-brand-green flex-shrink-0 flex items-center justify-center">
...
function productFormHTML(p) {
 ...
 <button type="button" onclick="openCameraScanner('pr-barcode')" class="flex-shrink-0 w-16 sm:w-20 border-4 border-brand-black flex items-center justify-center bg-brand-white text-brand-black hover:bg-brand-black hover:text-brand-white focus:outline-none " aria-label="Escanear con cámara">
...
function renderPagos() {
 const btnClasses = "font-display font-bold uppercase tracking-widest px-4 py-2 text-xs bg-brand-white text-brand-black border-4 border-brand-black hover:bg-brand-black hover:text-brand-white focus:bg-brand-black focus:text-brand-white active:bg-brand-black active:text-brand-white focus:outline-none";
 const rowClasses = "border-b-4 border-brand-black hover:bg-brand-green focus-within:bg-brand-green group";
...
function showKioskAlert(log) {
 ...
 actionHTML = `
 <button onclick="openModal('member-edit', ${m.id}); document.getElementById('${alertId}').remove();" class="w-full mt-4 text-center bg-brand-white text-brand-black font-display font-bold uppercase tracking-widest px-6 py-4 text-sm hover:bg-brand-green focus:bg-brand-green border-4 border-brand-white focus:outline-none active:bg-brand-green active:border-brand-green">
 Revisar Perfil
 </button>
 `;
 } else {
 ...
 actionHTML = m ? `
 <button onclick="openPagoForm(${m.id}); document.getElementById('${alertId}').remove();" class="w-full mt-4 text-center bg-brand-white text-brand-black font-display font-bold uppercase tracking-widest px-6 py-4 text-sm hover:bg-brand-green focus:bg-brand-green border-4 border-brand-white focus:outline-none active:bg-brand-green active:border-brand-green">
 Cobrar Ahora
 </button>
 ` : '';
 }
 ...
 <button onclick="document.getElementById('${alertId}').remove()" class="absolute top-4 right-4 text-current hover:text-brand-green focus:outline-none border-4 border-transparent focus:border-current hover:border-current p-1 flex items-center justify-center z-10 bg-[inherit]" aria-label="Cerrar alerta">
...
function renderCart() {
 ...
 <div class="flex items-stretch h-10 border-4 border-brand-black bg-brand-white divide-x-4 divide-brand-black">
 <button onclick="updateCartQty('${item.id}', -1)" data-sys-audio="decrement" class="w-10 flex items-center justify-center hover:bg-brand-green hover:text-brand-black focus:bg-brand-green focus:outline-none text-xl"><i class="ph-bold ph-minus"></i></button>
 <span class="font-display font-bold flex items-center justify-center text-lg flex-1 px-2">${item.qty}</span>
 <button onclick="updateCartQty('${item.id}', 1)" data-sys-audio="increment" class="w-10 flex items-center justify-center hover:bg-brand-green hover:text-brand-black focus:bg-brand-green focus:outline-none text-xl"><i class="ph-bold ph-plus"></i></button>
 </div>
...
window.renderInventoryTableBody = function(query = '') {
 ...
 <div class="flex items-stretch h-12 border-4 border-brand-black bg-brand-white divide-x-4 divide-brand-black">
 <button onclick="updateStock('${p.id}', -1)" data-sys-audio="decrement" class="w-12 flex items-center justify-center hover:bg-brand-green hover:text-brand-black focus:bg-brand-green focus:outline-none text-xl"><i class="ph-bold ph-minus"></i></button>
 <span class="font-display font-bold text-2xl tracking-tighter flex-1 flex items-center justify-center px-2">${safeStock}</span>
 <button onclick="updateStock('${p.id}', 1)" data-sys-audio="increment" class="w-12 flex items-center justify-center hover:bg-brand-green hover:text-brand-black focus:bg-brand-green focus:outline-none text-xl"><i class="ph-bold ph-plus"></i></button>
 </div>
